        ...
        <div class="nav-header">
            <div class="brand-logo">
                <a href="{{ url('/dashboard') }}">
                    <b class="logo-abbr"><img src="{{ asset('icons/favicon.png') }}" alt=""> </b>
                    <span class="logo-compact"><img src="{{ asset('icons/treize.png') }}" width="110" alt=""></span>
                    <span class="brand-title">
                        <img src="{{ asset('icons/treize.png') }}" width="110" alt="">
                    </span>
                </a>
            </div>
        </div>
