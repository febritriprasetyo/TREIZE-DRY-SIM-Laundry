...
<body>
	<div class="header">
		<table style="width: 100%;" class="table-header">
			<tr>
				<td class="text-left" style="padding-top: 50px; padding-left: 50px; padding-right: 50px; font-weight: bold; color: #454545;">{{ $transaksis->nama_outlet }}<br>{{ $transaksis->alamat_outlet }}</td>
			</tr>
			<tr>
				<td colspan="2" style="text-align: left; padding-left: 50px; padding-top: -5px; color: #7571f9;">{{ $transaksis->email_outlet }}<br>{{ $transaksis->hotline }}</td>
			</tr>
			<tr>
			...
			<tr>
				<td style="padding-left: 50px; line-height: 1.3; text-align: left;" colspan="2"><span style="color: #7571f9;">Username: </span><i>{{ $pelanggans->username }}</i><br><span style="color: #7571f9;">Password: </span><i>{{ $transaksis->password_pelanggan }}</i></td>
			</tr>
		</table>
	</div>
