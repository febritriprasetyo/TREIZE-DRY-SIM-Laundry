...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo e(url('/edit_paket_kiloan/' . $id)); ?>">Edit Paket Kiloan</a></li>
        </ol>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="<?php echo e(url('/update_paket_kiloan/' . $id)); ?>" method="post" name="edit_paket_kiloan_form">
                            <?php echo csrf_field(); ?>
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label" for="val-kode-paket">Kode Paket <span class="text-danger">*</span>
                                </label>
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" id="val-kode-paket" name="kd_paket" readonly="readonly" value="<?php echo e($paket_kilos->kd_paket); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" id="val-nama" name="nama_paket" placeholder="Masukkan nama paket" value="<?php echo e($paket_kilos->nama_paket); ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="val-harga" name="harga_paket" placeholder="Masukkan harga paket" value="<?php echo e($paket_kilos->harga_paket); ?>">
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="val-hari" name="hari_paket" placeholder="Masukkan lama hari" min="1" value="<?php echo e($paket_kilos->hari_paket); ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="val-minimal-berat" name="min_berat_paket" placeholder="Masukkan minimal berat paket" min="1" value="<?php echo e($paket_kilos->min_berat_paket); ?>">
                                        <div class="input-group-append">
...
var id_outlet = "<?php echo e($paket_kilos->id_outlet); ?>";

$(document).ready(function(){
    $('.'+id_outlet+'_outlet_id').prop('selected', true);

    if(<?php echo e($paket_kilos->antar_jemput_paket); ?> == 1)
    {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('halaman_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\SOFTWARE 2\xampp\htdocs\laundry-management-system\resources\views/halaman_paket/halaman_edit_paket_kiloan.blade.php ENDPATH**/ ?>