...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo e(url('/tambah_paket_kiloan')); ?>">Tambah Paket Kiloan</a></li>
        </ol>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="<?php echo e(url('/simpan_paket_kiloan')); ?>" method="post" name="paket_kiloan_baru_form">
                            <?php echo csrf_field(); ?>
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label" for="val-kode-paket">Kode Paket <span class="text-danger">*</span>
                                </label>
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" id="val-kode-paket" name="kd_paket" readonly="readonly" value="<?php echo e($max_code); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('halaman_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\SOFTWARE 2\xampp\htdocs\laundry-management-system\resources\views/halaman_paket/halaman_tambah_paket_kiloan.blade.php ENDPATH**/ ?>