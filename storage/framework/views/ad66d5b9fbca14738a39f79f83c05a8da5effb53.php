...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo e(url('/layanan_member/' . $id)); ?>">Layanan Member</a></li>
        </ol>
    </div>
</div>
                ...
                <div class="card-body">
                	<div class="row">
                		...
                		<div class="col-md-3 text-right foto-pelanggan">
                			<img src="<?php echo e(asset('/pictures/'.$akun_pelanggans->avatar)); ?>" class="rounded-circle mr-3 fotouser" alt="">
                		</div>
                		<div class="col-md-4 akun-pelanggan text-left">
	                		<h2><?php echo e($pelanggans->kd_pelanggan); ?></h2>
	                		<p><?php echo e($pelanggans->nama_pelanggan); ?></p>
            			...
            			<div class="col-md-4 identitas-pelanggan">
            				<table style="width: 100%; margin-left: -20px;" class="text-left table-identitas">
            					...
            					<tr>
            						<th>No HP</th>
            						<td>:</td>
            						<td><?php echo e($pelanggans->no_hp_pelanggan); ?></td>
            					</tr>
            					<tr>
            						<th>Email</th>
            						<td>:</td>
            						<td><?php echo e($pelanggans->email_pelanggan); ?></td>
            					</tr>
            					<tr>
            						<th>Alamat</th>
            						<td>:</td>
            					...
            					<tr>
            						<td colspan="3"><?php echo e($pelanggans->alamat_pelanggan); ?></td>
            					</tr>
            				</table>
            			</div>
                	...
                	<form class="layanan-member-form" method="POST">
                		...
                		<div class="form-member" hidden="">
                			<input type="text" name="kd_pelanggan" value="<?php echo e($pelanggans->kd_pelanggan); ?>">
                		</div>
...
$(document).on('change', '.pilih_outlet', function() {
    if($(this).val() == ""){
      ...
      $.ajax({
        url: "<?php echo e(url('sort_outlet_tabel_kiloan')); ?>/" + sort_by,
        success:function(data){
          $('#daftar_paket_kiloan').html(data);
        }
      });
      $.ajax({
        url: "<?php echo e(url('sort_outlet_tabel_satuan')); ?>/" + sort_by,
        success:function(data){
	...
	if(($(".layanan-member-form").valid() == true && check_paket_laundry == true) || ($(".layanan-member-form").valid() == true && jumlah_barang_satuan != 0))
	{
        if(cek_metode_pembayaran_kilo == 1 || cek_metode_pembayaran_satu == 1){
            if(bayar_bayar_kilo >= total_bayar_kilo_2 || bayar_bayar_satu >= total_bayar_satu_2){
                ...
                $.ajax({
                    url: "<?php echo e(url('/simpan_pesanan')); ?>",
                    method: "POST",
                    data: request,
                    contentType: false,
                    cache: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('halaman_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\SOFTWARE 2\xampp\htdocs\laundry-management-system\resources\views/halaman_pelanggan/halaman_layanan_member.blade.php ENDPATH**/ ?>