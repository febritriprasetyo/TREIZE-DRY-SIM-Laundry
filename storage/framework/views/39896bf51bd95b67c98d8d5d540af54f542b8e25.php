						...
						<div class="col-md-4">
							<div class="row">
								<div class="col-md-12 text-center">
									...
									<img src="<?php echo e(asset('gif/selesai.gif')); ?>" class="selesai-gif" hidden="">
									<img src="<?php echo e(asset('gif/scooter-running.gif')); ?>" class="diantar-gif" hidden="">
									<img src="<?php echo e(asset('gif/completed.gif')); ?>" class="diambil-gif" hidden="">
								</div>
								<div class="col-md-12">
					...
					<div class="table-responsive" id="table_proses">
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                            	...
                            	<tr>
                            		<th class="text-center"><?php echo e($number1); ?></th>
                            		...
                            		<td class="text-center"><button class="btn btn-sm btn-primary font-weight-bold btn-lihat" data-id="<?php echo e($transaksi->id); ?>">Lihat</button></td>
                            	</tr>
                            	<?php $number1++; ?>
                            	<?php endif; ?>
					...
					<div class="table-responsive" id="table_selesai" hidden="">
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                            	...
                            	<tr>
                            		<th class="text-center"><?php echo e($number2); ?></th>
                            		<th><?php echo e($transaksi->nama_outlet); ?></th>
                            		<td class="text-center"><?php echo e($transaksi->kd_invoice); ?></td>
                            		<td class="text-center"><?php echo e(date('d M Y', strtotime($transaksi->tgl_pemberian))); ?></td>
                    ...
                    <div class="table-responsive" id="table_diantar" hidden="">
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                            	<?php $number3 = 1; ?>
                            	<?php $__currentLoopData = $transaksis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaksi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            	<?php if($transaksi->status == 'diantar'): ?>
                            	<tr>
                            		<th class="text-center"><?php echo e($number3); ?></th>
                            		<th><?php echo e($transaksi->nama_outlet); ?></th>
                            		<td class="text-center"><?php echo e($transaksi->kd_invoice); ?></td>
                            		<td class="text-center"><?php echo e(date('d M Y', strtotime($transaksi->tgl_pemberian))); ?></td>
                            		<td class="text-center"><?php echo e(date('d M Y', strtotime($transaksi->tgl_selesai))); ?></td>
                    ...
                    <div class="table-responsive" id="table_diambil" hidden="">
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                            	...
                            	<tr>
                            		<th class="text-center"><?php echo e($number4); ?></th>
                            		<th><?php echo e($transaksi->nama_outlet); ?></th>
                            		<td class="text-center"><?php echo e($transaksi->kd_invoice); ?></td>
                            		<td class="text-center"><?php echo e(date('d M Y', strtotime($transaksi->tgl_pemberian))); ?></td>
                            		<td class="text-center"><?php echo e(date('d M Y', strtotime($transaksi->tgl_selesai))); ?></td>
...
<script type="text/javascript">
	...
	$(document).on('click', '.btn-lihat', function(e){
		...
		$.ajax({
			url: "<?php echo e(url('/lihat_pesanan_pelanggan')); ?>/" + id,
			method: "GET",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('halaman_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\SOFTWARE 2\xampp\htdocs\laundry-management-system\resources\views/halaman_pesanan_pelanggan/pesanan_pelanggan_member.blade.php ENDPATH**/ ?>