                    ...
                    <div class="default-tab">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="paket_kiloan" role="tabpanel">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card" style="background-color: transparant;">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-center">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <div></div>
                                                    <button type="button" class="btn mb-1 btn-primary font-weight-bold btn-sm tambah_kiloan_btn" data-count="<?php echo e($outlets); ?>">Tambah Paket <span class="btn-icon-right"><i class="fa fa-plus"></i></span></button>
                                                </div>
                                                    ...
                                                    <table class="table table-bordered zero-configuration">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th class="align-middle text-center"><?php echo e($paket_kilo->kd_paket); ?></th>
                                                                <td><?php echo e($paket_kilo->nama_paket); ?></td>
                                                                ...
                                                                <td style="text-align: center;">
                                                                    <div class="dropdown custom-dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item lihat_btn_kilo" href="#" role="button" data-lihat="<?php echo e($paket_kilo->id); ?>" data-toggle="modal" data-target="#lihatModalKiloan">Lihat</a> <a class="dropdown-item" href="<?php echo e(url('/edit_paket_kiloan/'.$paket_kilo->id)); ?>">Edit</a>
                                                                        </div>
                                                                    </div>&nbsp;&nbsp;
                                                                    <a href="<?php echo e(url('/hapus_paket_kiloan/'.$paket_kilo->id)); ?>" style="color: grey;"><i class="fa fa-trash c-primary" style="font-size: 16px;"></i></a>
                                                                </td>
                                                            </tr>
                                        ...
                                        <div class="card" style="background-color: transparant;">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <button type="button" class="btn mb-1 btn-primary font-weight-bold btn-sm tambah_satuan_btn" data-count="<?php echo e($outlets); ?>">Tambah Paket <span class="btn-icon-right"><i class="fa fa-plus"></i></span></button>
                                                </div>
                                                <div class="table-responsive">
                                                    <table class="table table-bordered zero-configuration">
                                                        <thead style="text-align: center;">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <th class="align-middle text-center"><?php echo e($loop->iteration); ?></th>
                                                                <th class="align-middle text-center"><?php echo e($paket_satu->kd_barang); ?></th>
                                                                <td><?php echo e($paket_satu->nama_barang); ?></td>
                                                                <td><?php echo e($paket_satu->ket_barang); ?></td>
                                                                <td>Rp. <?php echo e(number_format($paket_satu->harga_barang,2,',','.')); ?></td>
                                                                <td style="text-align: center;">
                                                                    <div class="dropdown custom-dropdown">
                                                                        <div data-toggle="dropdown" style="padding: 5px;"><i class="fa fa-ellipsis-v c-primary" style="font-size: 16px;"></i>
                                                                        </div>
                                                                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item lihat_btn_satu" href="#" role="button" data-lihat="<?php echo e($paket_satu->id); ?>" data-toggle="modal" data-target="#lihatModalSatuan">Lihat</a> <a class="dropdown-item" href="<?php echo e(url('/edit_paket_satuan/'.$paket_satu->id)); ?>">Edit</a>
                                                                        </div>
                                                                    </div>&nbsp;&nbsp;
                                                                    <a href="<?php echo e(url('/hapus_paket_satuan/'.$paket_satu->id)); ?>" style="color: grey;"><i class="fa fa-trash c-primary" style="font-size: 16px;"></i></a>
                                                                </td>
                                                            </tr>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </tbody>
...
$(document).on('click', '.lihat_btn_kilo', function(e){
    ...
    $.ajax({
        url: "<?php echo e(url('/lihat_paket_kiloan')); ?>/" + id,
        method: "GET",
...
$(document).on('click', '.lihat_btn_satu', function(e){
    ...
    var id = $(this).attr('data-lihat');
    $.ajax({
        url: "<?php echo e(url('/lihat_paket_satuan')); ?>/" + id,
        method: "GET",
        success:function(response){
...
$(document).on('click', '.tambah_kiloan_btn', function(e){
    ...
    {
        window.open("<?php echo e(url('/tambah_paket_kiloan')); ?>","_self");
    }else{
        outlet_kosong();
    }
});
...
$(document).on('click', '.tambah_satuan_btn', function(e){
    ...
    if(parseInt(cek_count) != 0)
    {
        window.open("<?php echo e(url('/tambah_paket_satuan')); ?>","_self");
    }else{
        outlet_kosong();
    }
});
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('halaman_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\SOFTWARE 2\xampp\htdocs\laundry-management-system\resources\views/halaman_paket/halaman_paket.blade.php ENDPATH**/ ?>