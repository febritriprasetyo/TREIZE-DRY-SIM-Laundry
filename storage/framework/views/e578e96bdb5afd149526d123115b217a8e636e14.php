...
<body>
	<div class="header">
		<table style="width: 100%;" class="table-header">
			...
			<tr>
				<td style="padding-right: 50px; text-align: right;"><b style="color: #454545;">TGL PEMBERIAN</b><br><?php echo e(date('d M Y', strtotime($transaksis->tgl_pemberian))); ?></td>
			</tr>
			<tr>
				<td style="padding-left: 50px; line-height: 1.3; text-align: left;" colspan="2"><span style="color: #7571f9;">Username: </span><i><?php echo e($pelanggans->username); ?></i><br><span style="color: #7571f9;">Password: </span><i><?php echo e($transaksis->password_pelanggan); ?></i></td>
			</tr>
		</table>
	</div>
...
</body><?php /**PATH E:\SOFTWARE 2\xampp\htdocs\laundry-management-system\resources\views/halaman_pelanggan/pdf_pelanggan.blade.php ENDPATH**/ ?>