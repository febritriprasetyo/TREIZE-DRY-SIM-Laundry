...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo e(url('/kelola_transaksi')); ?>">Transaksi</a></li>
        </ol>
    </div>
</div>
                                        ...
                                        <div class="tab-content br-n pn">
                                            <div id="identitas-tab-diambil" class="tab-pane active">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 text-center">
                                                        <img src="<?php echo e(asset('gif/completed.gif')); ?>" class="gif-ambil">
                                                    </div>
                                                    <div class="col-md-12">
                                                        <hr>
                                                    </div>
                                        ...
                                        <div class="tab-content br-n pn">
                                            <div id="identitas-tab-diantar" class="tab-pane active">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 text-center">
                                                        <img src="<?php echo e(asset('gif/scooter-running.gif')); ?>" class="gif-antar">
                                                    </div>
					...
					<div class="table-responsive" id="member_table_selesai">
                        <table class="table table-bordered zero-configuration">
                            ...
                            <tbody>
                            	...
                            	<?php if($transaksi->cek_member == 'member' && $transaksi->status == 'selesai'): ?>
                            	<tr>
                            		...
                            		<td><?php echo e(date('d M Y', strtotime($transaksi->tgl_pemberian))); ?></td>
                            		<td><?php echo e(date('d M Y', strtotime($transaksi->tgl_selesai))); ?></td>
                            		<td class="text-center">
                            			<span class="label label-pill label-success"><?php echo e($transaksi->status); ?></span>
                            		</td>
                            		<td style="font-size: 16px;" class="text-center">
                            			<button data-toggle="modal" data-target="#lihatTransaksiSelesai" data-lihat="<?php echo e($transaksi->id); ?>" class="btn btn-sm btn-primary font-weight-bold lihat_selesai">Lihat</button>
                                    </td>
                            	</tr>
                            	<?php $number1++ ?>
                            	<?php endif; ?>
                    ...
                    <div class="table-responsive" id="member_table_diantar" hidden="">
                        <table class="table table-bordered zero-configuration">
                            ...
                            <tbody>
                                <?php $number2 = 1 ?>
                                <?php $__currentLoopData = $transaksis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaksi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($transaksi->cek_member == 'member' && $transaksi->status == 'diantar'): ?>
                                <tr>
                                    ...
                                    <td><?php echo e(date('d M Y', strtotime($transaksi->tgl_selesai))); ?></td>
                                    <td class="text-center">
                                        <span class="label label-pill label-danger"><?php echo e($transaksi->status); ?></span>
                                    </td>
                                    <td style="font-size: 16px;" class="text-center">
                                        <button data-toggle="modal" data-target="#lihatTransaksiDiantar" data-lihat="<?php echo e($transaksi->id); ?>" class="btn btn-sm btn-primary font-weight-bold lihat_diantar">Lihat</button>
                                    </td>
                                </tr>
                                <?php $number2++ ?>
                                <?php endif; ?>
                    ...
                    <div class="table-responsive" id="member_table_diambil" hidden="">
                        <table class="table table-bordered zero-configuration">
                            ...
                            <tbody>
                                <?php $number3 = 1 ?>
                                <?php $__currentLoopData = $transaksis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaksi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($transaksi->cek_member == 'member' && $transaksi->status == 'diambil'): ?>
                                <tr>
                                    <th class="align-middle text-center"><?php echo e($number3); ?></th>
                                    <th><?php echo e($transaksi->nama_outlet); ?></th>
                                    <td><?php echo e($transaksi->kd_invoice); ?></td>
                                    <td><?php echo e($transaksi->nama_pelanggan); ?></td>
                                    <td><?php echo e(date('d M Y', strtotime($transaksi->tgl_pemberian))); ?></td>
                                    <td><?php echo e(date('d M Y', strtotime($transaksi->tgl_selesai))); ?></td>
                                    <td class="text-center">
                                        <span class="label label-pill label-primary"><?php echo e($transaksi->status); ?></span>
                                    </td>
                                    <td style="font-size: 16px;" class="text-center">
                                        <button data-toggle="modal" data-target="#lihatTransaksiDiambil" data-lihat="<?php echo e($transaksi->id); ?>" class="btn btn-sm btn-primary font-weight-bold lihat_diambil">Lihat</button>
                                    </td>
                                </tr>
                                <?php $number3++ ?>
                                <?php endif; ?>
                    ...
                    <div class="table-responsive" id="non_member_table_selesai" hidden="">
                        <table class="table table-bordered zero-configuration">
                            ...
                            <tbody>
                            	<?php $number4 = 1 ?>
                            	<?php $__currentLoopData = $transaksis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaksi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            	<?php if($transaksi->cek_member == 'non_member' && $transaksi->status == 'selesai'): ?>
                            	<tr>
                            		<th class="align-middle text-center"><?php echo e($number4); ?></th>
                            		<th><?php echo e($transaksi->nama_outlet); ?></th>
                            		<td><?php echo e($transaksi->kd_invoice); ?></td>
                            		<td><?php echo e($transaksi->nama_pelanggan); ?></td>
                            		<td><?php echo e(date('d M Y', strtotime($transaksi->tgl_pemberian))); ?></td>
                    ...
                    <div class="table-responsive" id="non_member_table_diantar" hidden="">
                        <table class="table table-bordered zero-configuration">
                            ...
                            <tbody>
                                <?php $number5 = 1 ?>
                                <?php $__currentLoopData = $transaksis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaksi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($transaksi->cek_member == 'non_member' && $transaksi->status == 'diantar'): ?>
                                <tr>
                                    <th class="align-middle text-center"><?php echo e($number5); ?></th>
                                    <th><?php echo e($transaksi->nama_outlet); ?></th>
                                    <td><?php echo e($transaksi->kd_invoice); ?></td>
                                    <td><?php echo e($transaksi->nama_pelanggan); ?></td>
                                    <td><?php echo e(date('d M Y', strtotime($transaksi->tgl_pemberian))); ?></td>
                                    <td><?php echo e(date('d M Y', strtotime($transaksi->tgl_selesai))); ?></td>
                                    <td class="text-center">
                                        <span class="label label-pill label-light"><?php echo e($transaksi->status); ?></span>
                                    </td>
                                    <td style="font-size: 16px;" class="text-center">
                                        <button data-toggle="modal" data-target="#lihatTransaksiDiantar" data-lihat="<?php echo e($transaksi->id); ?>" class="btn btn-sm btn-primary font-weight-bold lihat_diantar">Lihat</button>
                                    </td>
                    ...
                    <div class="table-responsive" id="non_member_table_diambil" hidden="">
                        <table class="table table-bordered zero-configuration">
                            ...
                            <tbody>
                                <?php $number6 = 1 ?>
                                <?php $__currentLoopData = $transaksis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaksi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($transaksi->cek_member == 'non_member' && $transaksi->status == 'diambil'): ?>
                                <tr>
                                    <th class="align-middle text-center"><?php echo e($number6); ?></th>
                                    <th><?php echo e($transaksi->nama_outlet); ?></th>
                                    <td><?php echo e($transaksi->kd_invoice); ?></td>
                                    <td><?php echo e($transaksi->nama_pelanggan); ?></td>
                                    <td><?php echo e(date('d M Y', strtotime($transaksi->tgl_pemberian))); ?></td>
...
<script type="text/javascript">
    <?php if($message = Session::get('dibayar')): ?>
    swal(
        "Berhasil!",
        "<?php echo e($message); ?>",
        "success"
    ...
    <?php if($message = Session::get('diantar')): ?>
    swal(
        "Berhasil!",
        "<?php echo e($message); ?>",
        "success"
    ...
    <?php if($message = Session::get('diambil')): ?>
    swal(
        "Berhasil!",
        "<?php echo e($message); ?>",
        "success"
    ...
    $(document).on('click', '.lihat_diambil', function(e){
        ...
        $.ajax({
            url: "<?php echo e(url('/lihat_transaksi_diambil')); ?>/" + id,
            method: "GET",
    ...
    $(document).on('click', '.lihat_diantar', function(e){
        ...
        var id = $(this).attr('data-lihat');
        $.ajax({
            url: "<?php echo e(url('/lihat_transaksi_diantar')); ?>/" + id,
            method: "GET",
            success:function(response){
                $('.id_pdf').val(response.transaksis.id);
    ...
    $(document).on('click', '.lihat_selesai', function(e){
        ...
        var id = $(this).attr('data-lihat');
        $.ajax({
            url: "<?php echo e(url('/lihat_transaksi_selesai')); ?>/" + id,
            method: "GET",
            success:function(response){
    ...
    $(document).on('submit', '.bayar_form', function(e){
        ...
        $.ajax({
            url: "<?php echo e(url('/bayar_pesanan')); ?>",
            method: "POST",
            data: request,
            contentType: false,
            cache: false,
            ...
            success:function(data){
                if(data == 'sukses')
                {
                    window.open("<?php echo e(url('/kelola_transaksi')); ?>","_self");
                }
            }
        });
    });
    ...
    $(document).on('click', '.diantar_btn', function(e){
        ...
        $.ajax({
            url: "<?php echo e(url('/ubah_status_transaksi/diantar')); ?>/" + id,
            method: "GET",
            success:function(data){
                if(data == 'sukses'){
                    window.open("<?php echo e(url('/kelola_transaksi')); ?>","_self");
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('halaman_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\SOFTWARE 2\xampp\htdocs\laundry-management-system\resources\views/halaman_transaksi/halaman_transaksi.blade.php ENDPATH**/ ?>