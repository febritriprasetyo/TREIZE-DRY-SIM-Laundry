...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo e(url('/edit_outlet/' . $id)); ?>">Edit Outlet</a></li>
        </ol>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="<?php echo e(url('/update_outlet/' . $id)); ?>" method="post" name="edit_outlet_form">
                            <?php echo csrf_field(); ?>
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label" for="val-nama">Nama Outlet <span class="text-danger">*</span>
                                </label>
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" id="val-nama" name="nama" placeholder="Masukkan nama outlet" value="<?php echo e($outlets->nama); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" id="val-hotline" name="hotline" placeholder="Masukkan hotline" value="<?php echo e($outlets->hotline); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="email" class="form-control" id="val-email" name="email" placeholder="Masukkan email" value="<?php echo e($outlets->email); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <textarea class="form-control h-150px" rows="6" id="comment" placeholder="Masukkan alamat outlet" name="alamat"><?php echo e($outlets->alamat); ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="iframe_script" placeholder="Masukkan source code" value="<?php echo e($outlets->iframe_script); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('halaman_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\SOFTWARE 2\xampp\htdocs\laundry-management-system\resources\views/halaman_outlet/halaman_edit_outlet.blade.php ENDPATH**/ ?>