...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(url('/laporan_pegawai')); ?>">Laporan Pegawai</a></li>
            <li class="breadcrumb-item active"><a href="<?php echo e(url('/laporan_pegawai_riwayat/' . $id)); ?>">Riwayat Kerja Pegawai</a></li>
        </ol>
    </div>
</div>
	            ...
	            <div class="card-body border-top pt-4">
	            	...
	            	<div class="row">
	            		<div class="col-md-12 text-center mt-2 mb-2">
	            			<img src="<?php echo e(asset('/pictures/'.$users->avatar)); ?>" class="rounded-circle mr-3 fotouser" alt="">
	            			<hr>
	            		</div>
	            		<div class="col-md-12">
	            			<table style="width: 100%;" class="identitas-table">
	            				<tr>
	            					...
	            					<td class="align-top"><?php echo e($users->name); ?></td>
	            				</tr>
	            				<tr>
	            					<th class="align-top">Posisi</th>
	            					<td class="align-top">:</td>
	            					<td class="align-top"><?php echo e($users->role); ?></td>
	            				</tr>
	            				<tr>
	            					<th class="align-top">Kd Pengguna</th>
	            					<td class="align-top">:</td>
	            					<td class="align-top"><?php echo e($users->kd_pengguna); ?></td>
	            				</tr>
	            			</table>
	            		</div>
	            	</div>
	    ...
	    <div class="col-lg-9">
	    	<div class="card">
	    		<div class="card-body border-top pt-4">
	    			...
	    			<div class="row mt-4">
	    				<div class="col-md-12">
	    					<form class="filter_form" target="_blank" action="<?php echo e(url('/pdf_laporan_pegawai/' . $id)); ?>" method="POST">
                    			<?php echo csrf_field(); ?>
...
<script type="text/javascript">
	...
	$('.filter_form').submit(function(e){
		...
		if(check_button == 'filter'){
			...
			$.ajax({
				url: "<?php echo e(url('/filter_laporan_pegawai/'.$id)); ?>",
				method: "POST",
				data: request,
				contentType: false,
				processData: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('halaman_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\SOFTWARE 2\xampp\htdocs\laundry-management-system\resources\views/halaman_laporan/halaman_laporan_riwayat.blade.php ENDPATH**/ ?>