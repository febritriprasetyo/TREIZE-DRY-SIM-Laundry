...
<body>
  ...
  <section id="hero">
    <div class="hero-container">
      <a href="#hero" class="hero-logo" data-aos="zoom-in"><img src="<?php echo e(asset('assets/img/treize.png')); ?>" alt="" width="400"></a>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <a href="#hero"><img src="<?php echo e(asset('assets/img/treize.png')); ?>" alt="" class="img-fluid"></a>
      </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-right">
            <div class="image">
              <img src="<?php echo e(asset('assets/img/tentangkami.jpg')); ?>" class="img-fluid" alt="" width="800">
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="image col-lg-6 order-1 order-lg-2 mt-4" data-aos="fade-left" data-aos-delay="100">
              <img src="<?php echo e(asset('assets/img/services.jpg')); ?>" class="img-fluid" alt="" width="800">
          </div>
        </div>
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 pl-0 pl-lg-0" data-aos="fade-right">
            <div class="tab-content">
              <div class="tab-pane active show" id="tab-1">
                <figure>
                  <img src="<?php echo e(asset('assets/img/Paket-laundry.jpg')); ?>" alt="" class="img-fluid" width="800">
                </figure>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="box" data-aos="zoom-in" data-aos-delay="100">
              <img src="<?php echo e(asset('assets/img/pricing/paketmini.jpg')); ?>" class="pricing-img mt-4" alt="">
              <h3>Paket Mini</h3>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-md-0">
            <div class="box recommended" data-aos="zoom-in">
              ...
              <img src="<?php echo e(asset('assets/img/pricing/paketextra.jpg')); ?>" class="pricing-img mt-4" alt="">
              <h3>Paket Extra</h3>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
            <div class="box" data-aos="zoom-in" data-aos-delay="100">
              <img src="<?php echo e(asset('assets/img/pricing/paketsatuan.jpg')); ?>" class="pricing-img mt-4" alt="">
              <h3>Paket Satuan</h3>
...
</html><?php /**PATH E:\SOFTWARE 2\xampp\htdocs\laundry-management-system\resources\views/welcome.blade.php ENDPATH**/ ?>