...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo e(url('/registrasi_pelanggan')); ?>">Registrasi Pelanggan</a></li>
        </ol>
    </div>
</div>
                        ...
                        <div class="tab-content br-n pn">
                            <div id="slide-1" class="tab-pane active identitas-tab">
                                <div class="row align-items-center">
                                    <div class="col-lg-12">
                                        <div class="alert alert-info">Layanan pelanggan member tersedia pada halaman <a href="<?php echo e(url('/kelola_pelanggan')); ?>" class="alert-link">Kelola Pelanggan</a></div>
    ...
    if($(".registrasi-form").valid() == true)
    {
        if(cek_metode_pembayaran_kilo == 1 || cek_metode_pembayaran_satu == 1){
            if(bayar_bayar_satu >= total_bayar_satu_2 || bayar_bayar_kilo >= total_bayar_kilo_2){
                ...
                $.ajax({
                    url: "<?php echo e(url('/simpan_pelanggan')); ?>",
                    method: "POST",
                    data: request,
                    contentType: false,
                    cache: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('halaman_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\SOFTWARE 2\xampp\htdocs\laundry-management-system\resources\views/halaman_pelanggan/registrasi_pelanggan.blade.php ENDPATH**/ ?>